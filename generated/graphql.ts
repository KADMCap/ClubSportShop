...
export type CreateProductReviewMutation = { __typename?: 'Mutation', review?: { __typename?: 'Review', id: string, stage: Stage, user: string, date: any, rating: number, content: string } | null };
